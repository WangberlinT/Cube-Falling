...
public class Mud : Cube
{
    private Rigidbody rigidbody;
    private CubeActor actor;
    public Mud(Vector3 pos, World world) : base(pos)
    {
        this.world = world;
        cube = GameObject.Instantiate(PrefabManager.GetInstance().GetPrefab(PrefabType.Mud).GetGameObject());
